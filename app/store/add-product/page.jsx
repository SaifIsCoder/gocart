...
export default function StoreAddProduct() {
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            // Get store ID from user - you may need to fetch this from Firestore
            // For now, using a placeholder
            const storeId = user?.uid || "default_store"
    ...
    return (
        <form onSubmit={onSubmitHandler} className="text-slate-500 mb-28">
            ...
            <button disabled={submitting} className="bg-slate-800 text-white px-6 mt-7 py-2 hover:bg-slate-900 rounded transition disabled:opacity-50">
