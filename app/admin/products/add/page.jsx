...
import { addProduct } from "@/app/lib/products-utils"
...
export default function AdminAddProduct() {
    ...
    const categories = ['Headphones', 'Speakers', 'Watch', 'Earbuds', 'Mouse', 'Decoration', 'Electronics', 'Clothing', 'Home & Kitchen', 'Beauty & Health', 'Toys & Games', 'Sports & Outdoors', 'Books & Media', 'Food & Drink', 'Hobbies & Crafts', 'Others']
    ...
    const onSubmitHandler = async (e) => {
        ...
        try {
            ...
            // For admin, we'll use a default store ID or get from user's store
            const storeId = "admin_store" // You can modify this to get from user's store
    ...
    return (
        <form onSubmit={onSubmitHandler} className="text-slate-500 mb-28">
            ...
            <button 
                disabled={submitting} 
                className="bg-indigo-600 text-white px-6 mt-7 py-2 hover:bg-indigo-700 rounded transition disabled:opacity-50"
            >
